...
const url = 'http://172.20.10.3/api/images/product/'
// create a component
const ProductDetail = () => {
        ...
        <View style={styles.container}>
            <View style={wrapper}>
                <View style={header}>
                    ...
                    ><Ionicons name='chevron-back' size={SPACING * 3} color={COLOR.red}></Ionicons></TouchableOpacity>
                    <TouchableOpacity onPress={addToCart}><Ionicons name='cart-outline' size={SPACING * 3} color={COLOR.red}></Ionicons></TouchableOpacity>
                </View>
                <ScrollView
                    pagingEnabled={true}
