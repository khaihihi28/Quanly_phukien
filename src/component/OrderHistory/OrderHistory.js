    ...
    return (
        <View style={styles.container}>
            <View style={header}>
                ...
                <Text style={txtTittle}>Lịch sử</Text>
                <TouchableOpacity>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        return <View style={rowOrder}>
                            <View style={txtOrder}>
                                <Text style={titileOrder}>Mã hóa đơn:</Text>
                                <Text style={titileOrder}>Thời gian:</Text>
                                <Text style={titileOrder}>Trạng thái:</Text>
                                <Text style={titileOrder}>Thành tiền:</Text>
                            </View>
                            <View style={infoOrder}>
                                <Text style={txtGreen}>PK{item.id}</Text>
                                <Text style={txtPurple}>{item.date_order}</Text>
                                <Text style={txtGreen}>{item.status == 0 ? 'Chưa duyệt' : (item.status == 1 ? 'Đang giao' : 'Hoàn thành')}</Text>
